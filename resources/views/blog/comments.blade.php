...
<div id="formmessage">Success/Error Message Goes Here</div>
 ...
 <form id="contactform" class="gray-form form-row" role="form" method="post" action="http://themes.potenzaglobalsolutions.com/html/webster-responsive-multi-purpose-html5-template/php/contact-form.php">
