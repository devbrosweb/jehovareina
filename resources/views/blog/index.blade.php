        ...
        <div class="blog-entry mb-50">
          <div class="entry-image clearfix">
            <div class="owl-carousel bottom-center-dots" data-nav-dots="ture" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
              ...
              <div class="item">
                <img class="img-fluid" src="/frontend/images/blog/04.jpg" alt="">
              </div>
            </div>
          </div>
          <div class="blog-detail">
            ...
            <ul class="grid-post">
                 <li>
                  <div class="portfolio-item">
                    <img class="img-fluid" src="/frontend/images/blog/05.jpg" alt="">
                     </div>
                  </li>
                 <li>
                  <div class="portfolio-item">
                    <img class="img-fluid" src="/frontend/images/blog/06.jpg" alt="">
                     </div>
                  </li>
                  <li>
                  <div class="portfolio-item">
                     <img class="img-fluid" src="/frontend/images/blog/07.jpg" alt="">
                     </div>
                  </li>
                  <li>
                  <div class="portfolio-item">
                    <img class="img-fluid" src="/frontend/images/blog/08.jpg" alt="">
                     </div>
                  </li>
              </ul>
            </div>
